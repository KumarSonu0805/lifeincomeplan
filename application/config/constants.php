...
defined('PROJECT_NAME')        OR define('PROJECT_NAME',"Life Income Plan"); 
defined('OUR_BRAND')       	   OR define('OUR_BRAND',"");
defined('SESSION_YEAR')        OR define('SESSION_YEAR',"$curyear");
defined('SITE_SALT')           OR define('SITE_SALT',"Life Income Plan");
defined('TP')        		   OR define('TP',"li_"); // Table Prefix
...
if(isset($_SERVER['HTTP_HOST']) && ($_SERVER['HTTP_HOST']=='localhost')){
	...
	defined('DB_NAME')		? null : define('DB_NAME','db_lifeincome');
}
else{
	defined('DB_HOST')      ? null : define('DB_HOST', '127.0.0.1');
	defined('DB_USER')      ? null : define('DB_USER', 'u711511560_user_lifeincom');
	defined('DB_PASSWORD')  ? null : define('DB_PASSWORD', 'LifeIncomePLan@123#$');
	defined('DB_NAME')      ? null : define('DB_NAME', 'u711511560_db_lifeincom');
}